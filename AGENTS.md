...
- `SEED_TARGET=prod npx tsx scripts/test-ppn-coretax-recon.ts` — PPN Coretax 대조 (POST 대조 → MATCH/DIFF/MISSING 집계 + Coretax 전용행 + GET 반영 + idempotent, `[PPNRECON-E2E]` sentinel, period 2099-12). 순수 매칭 유닛은 `ppn-reconcile.test.ts` 7 cases.
