...
const K: Record<string, Tr> = {
  ...
  familyMaritalLabel: { id: 'Status Pernikahan', en: 'Marital Status', ko: '결혼 상태', ja: '婚姻状況', zh: '婚姻状况' },
  familySingle: { id: 'Lajang', en: 'Single', ko: '미혼', ja: '未婚', zh: '未婚' },
  familyMarried: { id: 'Menikah', en: 'Married', ko: '기혼', ja: '既婚', zh: '已婚' },
  familyJoint: { id: 'Menikah (gabung)', en: 'Married (joint)', ko: '기혼 (합산)', ja: '既婚（合算）', zh: '已婚（合并）' },
  familyDepUnit: { id: 'orang', en: 'person(s)', ko: '명', ja: '人', zh: '人' },
  familyPtkpHint: { id: 'Kode PTKP', en: 'PTKP code', ko: 'PTKP 코드', ja: 'PTKPコード', zh: 'PTKP代码' },
