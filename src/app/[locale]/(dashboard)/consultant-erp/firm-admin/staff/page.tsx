...
export default async function FirmAdminStaffPage({
  params,
}: {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-fuchsia-700 p-6 md:p-8 text-white mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mt-1">{t('staffTitle')}</h1>
        <p className="text-indigo-100 text-sm mt-1">{t('staffDesc')}</p>
      </div>
