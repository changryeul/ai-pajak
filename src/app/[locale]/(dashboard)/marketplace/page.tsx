  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <div className="relative mb-6">
        ...
        <Input placeholder="Cari berdasarkan nama firma..." value={search} onChange={e => setSearch(e.target.value)} className="pl-10 rounded-xl" />
      </div>

      {isLoading ? (
        <div className="text-center py-20"><Loader2 className="h-6 w-6 animate-spin mx-auto text-blue-600" /></div>
      ) : filtered.length === 0 ? (
        <div className="text-center py-20 text-gray-400">Tidak ada konsultan ditemukan</div>
      ) : (
