...
/**
 * Coretax 처리 — index landing.
 * lastCase가 있으면 즉시 /operator/coretax/[id]로 점프, 없으면 케이스 카드 그리드.
 */
...
export default function CoretaxLandingPage() {
  ...
  return (
    <div>
      <PageTitle title="Coretax 처리 — 고객 선택" />
      <h1 className="mb-1 text-2xl font-black text-slate-900">Coretax 처리</h1>
      <p className="mb-6 text-sm text-slate-500">처리할 케이스를 선택하세요. Supervisor 승인 후 Coretax 작업을 기록합니다.</p>
