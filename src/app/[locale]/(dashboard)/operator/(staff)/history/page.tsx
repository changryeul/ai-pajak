...
export default function OperatorHistoryLandingPage() {
  ...
  return (
    <div>
      <PageTitle title={t('historyTitle')} />
      <h1 className="mb-1 text-2xl font-black text-slate-900">{t('historyTitle')}</h1>
      <p className="mb-6 text-sm text-slate-500">{t('historySubtitle')}</p>
