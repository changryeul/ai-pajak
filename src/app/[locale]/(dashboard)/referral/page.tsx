  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
        <Gift className="h-6 w-6 text-purple-600" />{t('referralTitle')}
      </h1>
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-purple-50 to-indigo-50 mb-6">
        <CardContent className="p-6 text-center">
          ...
          <h2 className="text-lg font-bold text-gray-900">{t('inviteFriends')}</h2>
      ...
      {data && (
        <>
          <Card className="border-0 shadow-sm mb-6">
            <CardHeader><CardTitle className="text-base">{t('referralLink')}</CardTitle></CardHeader>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="border-0 shadow-sm"><CardContent className="p-5 text-center">
              ...
              <p className="text-xs text-gray-500">{t('totalReferrals')}</p>
            </CardContent></Card>
            <Card className="border-0 shadow-sm"><CardContent className="p-5 text-center">
              <DollarSign className="h-6 w-6 text-green-600 mx-auto mb-2" />
              <p className="text-2xl font-bold">Rp {data.stats.earnedRewards.toLocaleString('id-ID')}</p>
              <p className="text-xs text-gray-500">{t('totalRewards')}</p>
            </CardContent></Card>
          </div>
        </>
      )}
